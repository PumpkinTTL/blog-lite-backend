...
export type AuditTargetType = 'user' | 'post' | 'setting' | 'code' | 'plan' | 'membership' | 'comment' | 'media' | 'category' | 'tag';
...
export class AuditLogEntity {
  ...
  @Column({ type: 'varchar', length: 255, nullable: true, name: 'target_name' }) targetName: string | null;
  @Column({ type: 'varchar', length: 255, nullable: true, name: 'operator_name' }) operatorName: string | null;
